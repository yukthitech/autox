...
public class NamedNodeMapImpl
    ...
    protected int findNamePoint(String name, int start) {
    	...
    	//Custom code: Changed to ensure attributes order is retained
    	...
    	//if name is already present, return that index
    	List<Node> attrs = (List<Node>) this.nodes;
    	int i = 0;
    	...
    	//if not return last index so that new attr will get appended at end
    	return - (nodes.size() + 1);
