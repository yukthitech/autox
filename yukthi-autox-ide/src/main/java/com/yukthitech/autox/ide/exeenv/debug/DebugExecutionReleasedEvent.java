...
/**
 * This event is raised when a thread is released post a pause at a debug point.
 * @author akranthikiran
 */
public class DebugExecutionReleasedEvent implements IIdeEvent
{
	private ExecutionEnvironment executionEnvironment;

	private ServerMssgExecutionPaused pausedMssg;

	public DebugExecutionReleasedEvent(ExecutionEnvironment executionEnvironment, ServerMssgExecutionPaused pausedMssg)
	{
