...
public class DebugPanel extends JPanel implements IViewPanel
{
	...
	private static class FileLocation
	{
		...
		public FileLocation(Project project, File file)
		{
	...
	private final DebugSandbox sandboxPanel = new DebugSandbox();
	...
	public DebugPanel()
	{
		...
		tabbedPane_1.addTab("Sandbox", null, sandboxPanel, null);
	...
	private void onStackTraceSelectionChange(TreeSelectionEvent e)
	{
		...
		if(executionId.equals(activeEnv.getActiveThreadId()))
		{
			return;
		}
	...
	private synchronized void highlightDebugPoint(Project project, File file, int lineNo)
	{
		if(previousDebugHighlight != null)
		{
			FileEditor editor = fileEditorTabbedPane.getOpenFile(previousDebugHighlight.project, previousDebugHighlight.file);
		...
		previousDebugHighlight = new FileLocation(project, file);
	}
}
