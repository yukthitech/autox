 ...
 * @author akiran
 */
@Executable(name = "ioDeleteDir", group = Group.Io, message = "Deletes specified directory.")
public class DeleteDirStep extends AbstractStep
{
	 ...
	 */
	@Param(description = "Path of directory to delete.", required = true, sourceType = SourceType.EXPRESSION)
	private String path;
